...
con = pymysql.connect(host='localhost', user='root',
                      password='root', database='statlog')
...
print(f'O modelo está com eficácia de {tree_score}\n')
...
while flag:
    ...
    while x < 1 or x > 4:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'laufkont' (1 <= x <= 4): "))
    ...
    while x < 0 or x > 4:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'moral' (0 <= x <= 4):"))
    ...
    while x < 0 or x > 10:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'verw' (0 <= x <= 10):"))
    ...
    while x < 1 or x > 5:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'sparkont' (1 <= x <= 5):"))
    ...
    while x < 1 or x > 5:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'beszeit' (1 <= x <= 5):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'rate' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'famges' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 3:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'buerge' (1 <= x <= 3):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'wohnzeit' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'verm' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 3:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'weitkred' (1 <= x <= 3):"))
    ...
    while x < 1 or x > 3:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'wohn' (1 <= x <= 3):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'bishkred' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 4:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'beruf' (1 <= x <= 4):"))
    ...
    while x < 1 or x > 2:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'pers' (1 <= x <= 2):"))
    ...
    while x < 1 or x > 2:
        ...
        x = int(
            input(f"Valor incorreto. Entre com o valor correto para 'telef' (1 <= x <= 2):"))
    ...
    while x < 1 or x > 2:
        ...
        x = int(input(
            f"Valor incorreto. Entre com o valor correto para 'gastarb' (1 <= x <= 2):"))
...
results = tree.predict(Data.reshape(1, -1))
