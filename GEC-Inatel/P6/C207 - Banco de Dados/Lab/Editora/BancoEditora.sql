...
CREATE TABLE IF NOT EXISTS `bancoAula6`.`Editora` (
  ...
  INDEX `fk_Editora_Dono1_idx` (`Dono_cpf` ASC) VISIBLE,
  CONSTRAINT `fk_Editora_Dono1`
    FOREIGN KEY (`Dono_cpf`)
    REFERENCES `bancoAula6`.`Dono` (`cpf`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
