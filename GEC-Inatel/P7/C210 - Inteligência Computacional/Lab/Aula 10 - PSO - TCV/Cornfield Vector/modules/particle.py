...
class Particle:
    ...
    def update_velocity(self, gbest_pos):
        w = 0.5  # define o quanto a particula vai mudar de velocidade /  quanto menor o W mais rapido a particula altera a velocidade
        c1 = 1  # ajuste da velocidade cognitive
        c2 = 1  # ajuste da velocidade social
